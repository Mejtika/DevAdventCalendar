...
namespace DevAdventCalendarCompetition.Controllers
{
    ...
    public class TestController : Controller
    {
        ...
        public ActionResult Index(int testNumber, string answer = "")
        {
            ...
            {
                this.ModelState.AddModelError("CorrectAnswers", "Wystąpił błąd!");
                return this.View("Index", test);
            }

            if (this._testService.VerifyTestAnswer(finalAnswer, test.CorrectAnswers.Select(t => t.Answer).ToList()))
            {
            ...
            this.ModelState.AddModelError("CorrectAnswers", "Źle! Spróbuj ponownie :)");
