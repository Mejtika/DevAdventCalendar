...
namespace DevAdventCalendarCompetition.Tests
{
    public class ResultCalculationTest
    {
        ...
        {
            new UserTestCorrectAnswer { UserId = "1", TestId = 1, AnsweringTime = DateTime.Now, AnsweringTimeOffset = default },
            new UserTestCorrectAnswer { UserId = "1", TestId = 1, AnsweringTime = DateTime.Today.AddHours(-2), AnsweringTimeOffset = default },
            new UserTestCorrectAnswer { UserId = "1", TestId = 2, AnsweringTime = DateTime.Today.AddHours(-1), AnsweringTimeOffset = default }
        };

        private readonly List<UserTestWrongAnswer> _wrongAnswers = new List<UserTestWrongAnswer>
        {
            new UserTestWrongAnswer { UserId = "1", TestId = 1 },
            new UserTestWrongAnswer { UserId = "1", TestId = 1 },
            new UserTestWrongAnswer { UserId = "1", TestId = 2 }
        };
